...
impl<'a> DeltaHedge<'a> {
    ...
    pub fn new(stream: PairMarketStream<'a>, max_under_pos: f64, min_tte_hedge: f64, init_cash: f64)-> Self {
    ...
    fn calc_greek_exp(&self, cb_record: &CoinbaseRecord, kl_record: &KalshiRecord) -> Option<GreekExp> {
